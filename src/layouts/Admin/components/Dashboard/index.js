...
import LastestOrder from './LatestOrder';
...
function Dashboard() {
    ...
    const statisticsRating = async () => {
        try {
            const response = await StatisticService.statisticRating();
    ...
    const getTop5OrderLatest = async () => {
        try {
            const response = await StatisticService.getTop5OrderLatest();
            ...
            {loading ? (
                ...
                <div className="title">
                            ...
                            <div className="card card-body mb-4 shadow-sm">
                                <article className="icontext">
                                    ...
                                    <div className="text">
                                        ...
                                        <span>{total && formatter(total.totalSales)}</span>
                                    </div>
                                </article>
                            </div>
                        </div>
                            ...
                            <div className="card card-body mb-4 shadow-sm">
                                <article className="icontext">
                                    ...
                                    <div className="text">
                                        ...
                                        <span>{total && total.totalOrder}</span>
                                    </div>
                                </article>
                            </div>
                        </div>
                            ...
                            <div className="card card-body mb-4 shadow-sm">
                                <article className="icontext">
                                    ...
                                    <div className="text">
                                        ...
                                        <span>{total && total.totalProduct}</span>
                                    </div>
                                </article>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="card mb-4 shadow-sm">
                                <div className="card-body" style={{ minHeight: '425px' }}>
                                    <h5 className="card-title">Rating statistic</h5>
                                    <ChartStatisticsRating dataStatistic={rating} />
                                </div>
                            </div>
                        </div>
                    </div>
