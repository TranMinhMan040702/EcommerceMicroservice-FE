...
function ProductDetail() {
    ...
    const getReviews = async (productId) => {
        try {
            const response = await ReviewService.getAllReviewByProduct(productId);
                ...
                <>
                    {product && (
                        <>
                                ...
                                <div className="product container d-flex justify-content-between">
                                        ...
                                        <div className="small-images-container d-flex justify-content-center">
                                            {product.images.map((image, index) => {
                                                return (
                                                    <div
                                                        key={index}
                                                        className="small-images-item img-thumbnail"
                                                    >
                                                        <img
                                                            src={image}
                                                            alt=""
                                    ...
                                    <div className="product-des">
                                        ...
                                        <div className="price d-flex align-items-center">
                                            <h3>{formatter(product.promotionalPrice)}</h3>
                                        ...
                                        <div className="delivery-policy">
                                            <div className="delivery d-flex">
                                                ...
                                                <span>
                                                    Giao hàng đến: xã Tân Lập, huyện Tịnh Biên, tỉnh
                                                    An Giang
                                                </span>
                                            </div>
                            ...
                            <Rating reviews={reviews} rating={product.rating} />
                            <Policy />
                        </>
                    )}
                </>
