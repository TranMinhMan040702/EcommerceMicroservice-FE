                                        ...
                                        <td colSpan="4">
                                            <article style={{ float: 'right' }}>
                                                <dl className="d-flex">
                                                    ...
                                                    <dd style={{marginLeft: "30px", verticalAlign:"baseline", flexGrow: "1", textAlign:"center"}}>$3,556</dd>
                                                </dl>
                                                <dl className="d-flex">
                                                    <dt
                                                        style={{
                                                    ...
                                                    <dd style={{marginLeft: "30px", verticalAlign:"baseline", flexGrow: "1", textAlign:"center"}}>$56,907</dd>
                                                </dl>
                                                <dl className="d-flex">
                                                    <dt
                                                        style={{
                                                    ...
                                                    <d>
                                                        <b class="h5">$2,345</b>
                                                    </d style={{marginLeft: "30px", verticalAlign:"baseline", flexGrow: "1", textAlign:"center"}}d>
                                                </dl>
                                                <dl className="d-flex">
                                                    <dt
                                                        style={{
