        ...
        <div className="sidebar">
            ...
            <div className="center">
                <ul style={{ listStyle: 'none' }}>
                    ...
                    <Link to={config.routes.product} style={{ textDecoration: 'none' }}>
                        <li>
                    ...
                    <Link to={config.routes.category} style={{ textDecoration: 'none' }}>
                        <li>
                            <FontAwesomeIcon className="sidebar-icon" icon={faList} />
                            <span>Categories</span>
                        </li>
                    </Link>
                    <Link to={config.routes.orders} style={{ textDecoration: 'none' }}>
                        <li>
                            <FontAwesomeIcon className="sidebar-icon" icon={faBagShopping} />
                            <span>Orders</span>
                        </li>
                    </Link>
                    <Link to={config.routes.users} style={{ textDecoration: 'none' }}>
                        <li>
                            <FontAwesomeIcon className="sidebar-icon" icon={faUser} />
                            <span>Users</span>
                        </li>
                    </Link>
                    <Link to={config.routes.seller} style={{ textDecoration: 'none' }}>
                        <li>
                            <FontAwesomeIcon className="sidebar-icon" icon={faStoreAlt} />
                            <span>Seller</span>
                        </li>
                    </Link>
                    <Link to={config.routes.transactions} style={{ textDecoration: 'none' }}>
                        <li>
