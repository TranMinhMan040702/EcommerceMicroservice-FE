        ...
        <div className="sidebar">
            ...
            <div className="center">
                <ul style={{ listStyle: 'none' }}>
                    ...
                    <Link to={routes.admin.orders} style={{ textDecoration: 'none' }}>
                        <li>
                    ...
                    <Link to={routes.admin.seller} style={{ textDecoration: 'none' }}>
                        <li>
                            <FontAwesomeIcon className="sidebar-icon" icon={faStoreAlt} />
                            <span>Seller</span>
                        </li>
                    </Link>
                    <Link to={routes.admin.transactions} style={{ textDecoration: 'none' }}>
                        <li>
