...
const REACT_APP_BASE_URL_ORDER_SERVICE = process.env.REACT_APP_BASE_URL_ORDER_SERVICE;
const REACT_APP_ORDER_API_URL =
    REACT_APP_BASE_URL_ORDER_SERVICE + process.env.REACT_APP_ORDER_API_URL;
const REACT_APP_ORDER_ADMIN_API_URL =
    REACT_APP_BASE_URL_ORDER_SERVICE + process.env.REACT_APP_ORDER_ADMIN_API_URL;
