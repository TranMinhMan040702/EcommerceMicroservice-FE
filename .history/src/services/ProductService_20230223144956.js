...
class ProductService {
    ...
    addProduct(product) {
        return axios.post(REACT_APP_PRODUCT_ADMIN_API_URL, product);
    }
    updateProduct(product, id) {
        return axios.post(REACT_APP_PRODUCT_ADMIN_API_URL + '/' + id, product);
    }
    deleteProduct(id) {
        return axios.delete(REACT_APP_PRODUCT_ADMIN_API_URL + '/' + id);
    }
}
