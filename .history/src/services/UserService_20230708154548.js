...
const REACT_APP_USER_API_URL =
    process.env.REACT_APP_BASE_URL_INDENTITY_SERVICE + process.env.REACT_APP_USER_API_URL;
const REACT_APP_USER_ADMIN_API_URL =
    process.env.REACT_APP_BASE_URL_INDENTITY_SERVICE + process.env.REACT_APP_USER_ADMIN_API_URL;
