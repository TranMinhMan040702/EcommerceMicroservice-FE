                                ...
                                <div className="row">
                                    <div className="col-lg-3">
                                        <input
                                            ...
                                            name="image1"
                                        />
                                        <div className="image-product w-100">
                                            <img
                                                className="w-100 h-100"
                                                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fpatterns.dev%2Fposts%2Freactjs%2F&psig=AOvVaw1RLMsbMuTV7NDD1D6AHt_u&ust=1674828866922000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCMj23u-15fwCFQAAAAAdAAAAABAD"
                                                alt=""
                                            />
                                        </div>
                                    </div>
