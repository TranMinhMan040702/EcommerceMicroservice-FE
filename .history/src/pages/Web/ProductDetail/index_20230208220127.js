        ...
        <div className="product-detail">
            <div className="product container d-flex justify-content-between">
                ...
                <div className="product-des">
                    ...
                    <div className="deliver-policy">
                        <h6>
                            Thời gian giao hàng: <span>Giao hàng đến: xã Tân Lập, huyện Tịnh Biên, tỉnh An Giang</span>
                        </h6>
                        <h6>
                            Chính sách đổi trả: <span>Đổi trả sản phẩm trong vòng 30 ngày</span>
                        </h6>
                    </div>
