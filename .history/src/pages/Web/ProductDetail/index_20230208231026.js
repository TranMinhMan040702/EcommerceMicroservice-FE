                ...
                <div className="product-imgs">
                    ...
                    <div className="small-images-container d-flex justify-content-center">
                        <div className="small-images-item img-thumbnail">
                            <img src={images.products.p1} alt="" onMouseEnter={(e) => handleImage()} />
                        </div>
                        <div className="small-images-item img-thumbnail">
                            <img src={images.products.p2} alt="" onMouseEnter={(e) => handleImage()} />
                        </div>
                        <div className="small-images-item img-thumbnail">
                            <img src={images.products.p3} alt="" onMouseEnter={(e) => handleImage()} />
                        </div>
                        <div className="small-images-item img-thumbnail">
                            <img src={images.products.p4} alt="" onMouseEnter={(e) => handleImage()} />
                        </div>
                    </div>
                </div>
